    ...
    >
      ...
      <div className="container">
        <div style={{ maxWidth: '680px' }}>
          ...
          >
            A passionate software developer from Nairobi, Kenya building
            full-stack web applications that solve real-world problems.
            Specializing in the MERN stack with a focus on clean code and great
            user experiences.
          </p>
          ...
          >
            ...
            <a
              href="https://github.com/MrLuvutse"
              target="_blank"
              rel="noreferrer"
              className="btn btn-outline"
            >
          ...
          <div style={{ display: 'flex', gap: '40px', marginTop: '60px', flexWrap: 'wrap' }}>
            {STATS.map((s) => (
              <div key={s.label}>
                <div style={{ fontSize: '32px', fontWeight: 800, color: '#6c63ff' }}>
                  {s.num}
                </div>
